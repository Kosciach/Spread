...
public class PlayerWalkState : PlayerBaseState
{
    ...
    {
        if (_ctx.SwitchController.IsSwitch(PlayerStateMachine.SwitchEnum.Run) && !_ctx.CombatController.EquipedWeaponController.Wall.IsWall) StateChange(_factory.Run());
