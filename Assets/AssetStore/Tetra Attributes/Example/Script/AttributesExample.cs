...
namespace TetraCreations.Attributes
{
    public class AttributesExample : MonoBehaviour
    {
        ...
        public DirectionsExample SelectedDirections;
        [DrawIf(nameof(SelectedDirections), DirectionsExample.North | DirectionsExample.West, type: typeof(DirectionsExample))]
        ...
        void Start()
        {
            Debug.Log("Path : "+ PathReference.Path + " - GUID : "+PathReference.GUID);
            Debug.Log("Selected Tag : " + Tag);
        }
